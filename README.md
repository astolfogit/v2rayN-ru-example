...
скачиваем <a href="https://raw.githubusercontent.com/astolfogit/proxy-client-ru/main/assets/check_updates.bat">updater script</a> для него (встроенного апдейтера ядра у клиента нет, поэтому я написал свой, он использует curl, jq и 7zip, их можно установить через winget по гайду в интернете).
<li>В настройках qsing-box выставляем <tt>Auto run</tt> и <tt>Run as administrator</tt>.</li>
